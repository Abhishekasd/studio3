...
import { Upload, Download, Loader2, Trash2, FileDown } from "lucide-react";
import { convertPdfToWord } from './actions';
...
export default function PdfToWordPage() {
  const [state, formAction] = useFormState(convertPdfToWord, {});
  ...
  const handleDownload = () => {
    ...
    // This creates a plain text file. A true DOCX would require a library like 'docx'.
    ...
    toast({ title: "Downloaded as .txt", description: "True .docx conversion coming soon!" });
  };
  ...
  return (
    <div className="container mx-auto px-4 py-8 md:px-6">
      <div className="text-center mb-8">
        <h1 className="text-4xl font-bold font-headline">PDF to Word Converter</h1>
        <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
          Convert your PDF to an editable document. Note: This feature is in beta and extracts text only.
        </p>
      </div>
      ...
      <Card className="max-w-xl mx-auto">
        <form action={formAction}>
            <CardHeader>
                ...
                <CardDescription>Select the PDF file you want to convert to Word.</CardDescription>
            </CardHeader>
